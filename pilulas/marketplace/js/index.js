...
player.addSource(new SourceVideo("marketplace/video/video8.mp4"));
player.addSource(new SourceVideo("marketplace/video/video9.mp4"));
player.addSource(new SourceVideo("marketplace/video/video10.mp4"));
player.addSource(new SourceVideo("marketplace/video/video11.mp4"));
player.addSource(new SourceVideo("marketplace/video/video12.mp4"));
player.addSource(new SourceVideo("marketplace/video/video13.mp4"));
player.addSource(new SourceVideo("marketplace/video/video14.mp4"));
player.addSource(new SourceVideo("marketplace/video/video15.mp4"));
