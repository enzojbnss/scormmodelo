...
player.addSource(new SourceVideo("marketplace/video/video.ogv"));
player.addSource(new SourceVideo("marketplace/video/video1.ogv"));
player.addSource(new SourceVideo("marketplace/video/video2.ogv"));
player.addSource(new SourceVideo("marketplace/video/video3.ogv"));
player.addSource(new SourceVideo("marketplace/video/video4.ogv"));
player.addSource(new SourceVideo("marketplace/video/video5.ogv"));
player.addSource(new SourceVideo("marketplace/video/video6.ogv"));
player.addSource(new SourceVideo("marketplace/video/video7.ogv"));
// inicializacao do player
